...
main = tkinter.Tk()
main.title("EMOTION DETECTION WITH IMAGE SYSTEM")
...
font = ('times', 20, 'bold')
title = Label(main, text='EMOTION DETECTION WITH IMAGE  SYSTEM')
title.config(bg='purple', fg='blue')  
...
pathlabel.config(bg='purple', fg='blue')  
...
emotionlabel.config(bg='purple', fg='blue')  
